...
| Remaining | Phase A：P0-10 ✅、P0-1 ✅、P0-2 ✅、P0-3 ✅（owner 已视觉复验确认 To 编辑框归位、错位组件消失、下拉可交互）；P0-4（取消信号 + 扫描单飞）待执行。P0-5~P0-9（数据安全底线）、P1/P2、Phase B–E 均未授权，禁止提前实施。发版动作（GIT-020 归 owner）：`git push origin main` 对齐分支引用（非阻塞）。 |
